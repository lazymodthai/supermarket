...
INSERT INTO `employee` (`employee_id`, `name`, `address`, `tel`, `salary`) VALUES
...
INSERT INTO `products` (`product_id`, `name`, `product_desc`, `cost`, `price`, `stock`, `shelf`, `supplier_id`) VALUES
...
INSERT INTO `supplier` (`supplier_id`, `name`, `address`, `contact_name`, `tel`) VALUES
(1, 'สยามแม็คโคร', 'กรุงเทพฯ', 'จ๋อง', '021234567'),
(2, 'บริษัทเสริมสุข', 'นนทบุรี', 'มาย', '023332222'),
(3, 'บริษัทยูนิลิเวอร์', 'ปทุมธานี', 'นก', '0812233345');
